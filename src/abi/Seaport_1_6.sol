...
interface Seaport_1_6 {
    ...
    ) external payable returns (bool[] memory, Execution[] memory);
    ...
    function fulfillBasicOrder(BasicOrderParameters memory) external payable returns (bool fulfilled);
    function fulfillBasicOrder_efficient_6GL6yc(BasicOrderParameters memory)
        external
        payable
